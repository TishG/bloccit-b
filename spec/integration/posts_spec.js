    ...
    describe("POST /topics/:topicId/posts/create", () => {
      it("should not create a new post", (done) => {
        const options = {
          ...
          form: {
            title: "Christmas is my favorite holiday.",
            body: "What is your favorite holiday to celebrate and why?"
          }
        };
        request.post(options,
          (err, res, body) => {
            Post.findOne({where: {title: "Christmas is my favorite holiday."}})
            .then((post) => {
      ...
      it("should create a new post and redirect", (done) => {
        ...
        request.post(options,
          (err, res, body) => {
            ...
            .then((post) => {
              expect(post).not.toBeNull();
              expect(post.title).toBe("Christmas is my favorite holiday.");
              expect(post.body).toBe("What is your favorite holiday to celebrate and why?");
